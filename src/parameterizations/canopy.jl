# Canopy mass-balance parameterizations: the AbstractCanopy schemes, their accessors, and the
# canopy's own snow interception physics (canopy_snow!). The radiation and surface-energy-balance
